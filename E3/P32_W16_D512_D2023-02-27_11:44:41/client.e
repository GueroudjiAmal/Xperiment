0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.1.83:8786' processes=16 threads=384, memory=2.70 TiB>>
...
0: distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.1.145:58944 remote=tcp://172.21.1.83:8786> already closed.
