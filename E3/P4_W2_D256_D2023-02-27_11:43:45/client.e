0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.1.87:8786' processes=2 threads=48, memory=345.47 GiB>>
...
0: distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.9.111:60192 remote=tcp://172.21.1.87:8786> already closed.
