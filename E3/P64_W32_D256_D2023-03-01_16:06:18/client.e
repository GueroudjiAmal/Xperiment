tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.1.21:8786' processes=32 threads=768, memory=5.40 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.1.25:53288 remote=tcp://172.21.1.21:8786> already closed.
