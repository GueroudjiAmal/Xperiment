tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.5.36:8786' processes=2 threads=48, memory=345.47 GiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.5.37:58036 remote=tcp://172.21.5.36:8786> already closed.
