tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.2.177:8786' processes=32 threads=768, memory=5.40 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.2.186:48242 remote=tcp://172.21.2.177:8786> already closed.
