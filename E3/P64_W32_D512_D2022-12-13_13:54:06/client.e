tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.0.180:8786' processes=32 threads=768, memory=5.40 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.0.183:41280 remote=tcp://172.21.0.180:8786> already closed.
