0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.5.39:8786' processes=2 threads=48, memory=345.47 GiB>>
...
0: distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.5.50:48464 remote=tcp://172.21.5.39:8786> already closed.
