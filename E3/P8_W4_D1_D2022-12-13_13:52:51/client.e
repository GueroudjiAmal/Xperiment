tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.9.64:8786' processes=4 threads=96, memory=690.94 GiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.9.65:39756 remote=tcp://172.21.9.64:8786> already closed.
