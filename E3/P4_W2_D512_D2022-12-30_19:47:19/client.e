tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.8.204:8786' processes=2 threads=48, memory=345.47 GiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.8.205:35140 remote=tcp://172.21.8.204:8786> already closed.
