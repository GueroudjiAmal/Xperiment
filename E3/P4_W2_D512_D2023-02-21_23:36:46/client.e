0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.6.241:8786' processes=2 threads=48, memory=345.47 GiB>>
...
0: distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.6.246:36184 remote=tcp://172.21.6.241:8786> already closed.
