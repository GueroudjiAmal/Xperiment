0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.1.18:8786' processes=4 threads=96, memory=690.94 GiB>>
...
0: distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.1.62:48300 remote=tcp://172.21.1.18:8786> already closed.
