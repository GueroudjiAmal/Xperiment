tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.2.212:8786' processes=8 threads=192, memory=1.35 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.2.213:56992 remote=tcp://172.21.2.212:8786> already closed.
