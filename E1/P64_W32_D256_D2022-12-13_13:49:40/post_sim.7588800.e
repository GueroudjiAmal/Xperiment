...
+ OMP_NUM_THREADS=24
+ echo nprocdask 66 nworker 64 nnodes 34
+ SCHEFILE=scheduler.json
+ echo Running Simulation
+ ccc_mprun -N 32 -n 64 -c 24 ./simulation
+ wait
++ which python
...
+ unset SELFIE_MPRUN
+ unset SELFIE_MSUB
+ ccc_msub -m work,scratch -r post_dask -q skylake -Q normal -A gen2224 -x -N 34 -n 66 Dask.sh
+ exit 0
