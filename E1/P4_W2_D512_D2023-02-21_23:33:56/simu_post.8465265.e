...
+ OMP_NUM_THREADS=24
+ echo nprocdask 4 nworker 2 nnodes 3
...
+ export OMP_NUM_THREADS=24
+ OMP_NUM_THREADS=24
+ ccc_msub -m work,scratch -r post_dask -q skylake -Q normal -A gen2224 -x -N 3 -n 4 Dask.sh
+ exit 0
