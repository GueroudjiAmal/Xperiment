0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.10.230:8786' processes=64 threads=1536, memory=10.80 TiB>>
...
0: distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.10.231:54322 remote=tcp://172.21.10.230:8786> already closed.
