...
+ ccc_mprun -N 256 -n 512 -c 24 -r 130 ./simulation
+ ccc_mprun -N 128 -n 256 -c 24 -r 2 dask-worker --local-directory /tmp --scheduler-file=scheduler.json
++ which python3
...
+ wait 94096
+ wait
slurmstepd-irene1000: error: *** JOB 7739019 ON irene1000 CANCELLED AT 2022-12-30T21:11:13 ***
