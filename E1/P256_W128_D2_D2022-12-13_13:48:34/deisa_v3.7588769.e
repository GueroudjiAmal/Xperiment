...
+ ccc_mprun -N 128 -n 256 -c 24 -r 66 ./simulation
+ ccc_mprun -N 64 -n 128 -c 24 -r 2 dask-worker --local-directory /tmp --scheduler-file=scheduler.json
++ which python3
...
slurmstepd-irene1276: error: *** JOB 7588769 ON irene1276 CANCELLED AT 2022-12-13T18:29:06 DUE TO TIME LIMIT ***
