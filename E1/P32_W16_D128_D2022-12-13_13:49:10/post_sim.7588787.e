...
+ OMP_NUM_THREADS=24
+ echo nprocdask 34 nworker 32 nnodes 18
+ SCHEFILE=scheduler.json
+ echo Running Simulation
+ ccc_mprun -N 16 -n 32 -c 24 ./simulation
+ wait
++ which python
+ /ccc/work/cont003/gen2224/gen2224/spack/var/spack/environments/gysela-deisa-irene-skl-draft/.spack-env/view/bin/python postscript.py
+ ml purge
+ module ml purge
+ unset _mlshdbg
+ '[' 1 = 1 ']'
...
+ unset SELFIE_MPRUN
+ unset SELFIE_MSUB
+ ccc_msub -m work,scratch -r post_dask -q skylake -Q normal -A gen2224 -x -N 18 -n 34 Dask.sh
+ exit 0
