tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.1.80:8786' processes=128 threads=3072, memory=21.59 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.1.85:48624 remote=tcp://172.21.1.80:8786> already closed.
