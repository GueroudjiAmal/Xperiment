...
+ OMP_NUM_THREADS=24
+ echo nprocdask 10 nworker 8 nnodes 6
+ SCHEFILE=scheduler.json
+ echo Running Simulation
+ ccc_mprun -N 4 -n 8 -c 24 ./simulation
+ wait
++ which python
...
+ unset SELFIE_MPRUN
+ unset SELFIE_MSUB
+ ccc_msub -m work,scratch -r post_dask -q skylake -Q normal -A gen2224 -x -N 6 -n 10 Dask.sh
+ exit 0
