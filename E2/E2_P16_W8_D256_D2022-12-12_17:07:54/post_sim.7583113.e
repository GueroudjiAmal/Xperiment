...
+ OMP_NUM_THREADS=24
+ echo nprocdask 18 nworker 16 nnodes 10
+ SCHEFILE=scheduler.json
+ echo Running Simulation
+ ccc_mprun -N 8 -n 16 -c 24 ./simulation
+ wait
++ which python
...
+ unset SELFIE_MPRUN
+ unset SELFIE_MSUB
+ ccc_msub -m work,scratch -r post_dask -q skylake -Q normal -A gen2224 -x -N 10 -n 18 Dask.sh
+ exit 0
