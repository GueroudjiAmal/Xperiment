...
+ ccc_mprun -N 4 -n 8 -c 24 -r 4 ./simulation
+ ccc_mprun -N 2 -n 4 -c 24 -r 2 dask-worker --local-directory /tmp --scheduler-file=scheduler.json
++ which python3
...
+ wait 61785
+ wait
slurmstepd-irene1488: error: *** JOB 7588801 ON irene1488 CANCELLED AT 2022-12-13T14:57:40 ***
