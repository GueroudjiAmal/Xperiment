...
+ OMP_NUM_THREADS=24
+ echo nprocdask 6 nworker 4 nnodes 4
+ SCHEFILE=scheduler.json
+ echo Running Simulation
+ ccc_mprun -N 2 -n 4 -c 24 ./simulation
+ wait
++ which python
...
+ unset SELFIE_MPRUN
+ unset SELFIE_MSUB
+ ccc_msub -m work,scratch -r post_dask -q skylake -Q normal -A gen2224 -x -N 4 -n 6 Dask.sh
+ exit 0
