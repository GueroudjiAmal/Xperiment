...
+ ccc_mprun -N 8 -n 16 -c 24 -r 6 ./simulation
+ ccc_mprun -N 4 -n 8 -c 24 -r 2 dask-worker --local-directory /tmp --scheduler-file=scheduler.json
++ which python3
...
+ wait 64153
+ wait
slurmstepd-irene2622: error: *** JOB 7588812 ON irene2622 CANCELLED AT 2022-12-13T15:01:31 ***
