tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.5.104:8786' processes=8 threads=192, memory=1.35 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.5.106:50832 remote=tcp://172.21.5.104:8786> already closed.
