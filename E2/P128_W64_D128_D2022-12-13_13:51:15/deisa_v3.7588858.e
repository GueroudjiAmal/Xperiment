...
+ ccc_mprun -N 64 -n 128 -c 24 -r 34 ./simulation
+ ccc_mprun -N 32 -n 64 -c 24 -r 2 dask-worker --local-directory /tmp --scheduler-file=scheduler.json
++ which python3
...
slurmstepd-irene1295: error: *** JOB 7588858 ON irene1295 CANCELLED AT 2022-12-13T18:27:01 DUE TO TIME LIMIT ***
