...
do
    ...
    do
        ...
        do
            ...
            mkdir -p DEISA1_PHD_IPCA_FIN_NATIVE
            DATE=$(date +"%Y-%m-%d_%T")
            WORKSPACE=$DIR/DEISA1_PHD_IPCA_NATIVE/E${X}/P${PAR}_W${NWORKER}_D${DATA}_D${DATE}/
            mkdir  -p $WORKSPACE
            cd $WORKSPACE
            ...
            ccc_msub  -m work,scratch -r deisa_v1 -q skylake -Q normal -A gen2224 -x  -N $NNODES -n $NPROC Script.sh     
        done
    done
done 
