tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.4.160:8786' processes=64 threads=1536, memory=10.80 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.4.161:60106 remote=tcp://172.21.4.160:8786> already closed.
