tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.2.160:8786' processes=16 threads=384, memory=2.70 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.2.161:41828 remote=tcp://172.21.2.160:8786> already closed.
