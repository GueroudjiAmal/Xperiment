0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.8.161:8786' processes=63 threads=1512, memory=10.63 TiB>>
...
0: distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.8.162:44380 remote=tcp://172.21.8.161:8786> already closed.
