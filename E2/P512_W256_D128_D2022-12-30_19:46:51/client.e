tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.2.160:8786' processes=256 threads=6144, memory=43.18 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.2.161:37938 remote=tcp://172.21.2.160:8786> already closed.
