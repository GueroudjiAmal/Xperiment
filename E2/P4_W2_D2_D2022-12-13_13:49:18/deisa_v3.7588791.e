...
+ ccc_mprun -N 2 -n 4 -c 24 -r 3 ./simulation
+ ccc_mprun -N 1 -n 2 -c 24 -r 2 dask-worker --local-directory /tmp --scheduler-file=scheduler.json
++ which python3
...
+ wait 44660
+ wait
slurmstepd-irene2191: error: *** JOB 7588791 ON irene2191 CANCELLED AT 2022-12-13T14:58:27 ***
