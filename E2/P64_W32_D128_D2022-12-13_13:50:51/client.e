tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.8.160:8786' processes=32 threads=768, memory=5.40 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.8.161:35774 remote=tcp://172.21.8.160:8786> already closed.
