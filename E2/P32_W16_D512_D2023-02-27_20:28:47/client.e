tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.1.66:8786' processes=16 threads=384, memory=2.70 TiB>>
...
distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.1.151:42412 remote=tcp://172.21.1.66:8786> already closed.
