0: distributed.batched - INFO - Batched Comm Closed <TCP (closed) Client->Scheduler local=tcp://172.21.0.161:34328 remote=tcp://172.21.0.160:8786>
...
0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.0.160:8786' processes=64 threads=1536, memory=10.80 TiB>>
0: Traceback (most recent call last):
...
0: distributed.comm.core.CommClosedError: Comm <TCP (closed) Client->Scheduler local=tcp://172.21.0.161:34328 remote=tcp://172.21.0.160:8786> already closed.
0: tornado.application - ERROR - Exception in callback <bound method Client._heartbeat of <Client: 'tcp://172.21.0.160:8786' processes=64 threads=1536, memory=10.80 TiB>>
0: Traceback (most recent call last):
0:   File "/ccc/work/cont003/gen2224/gen2224/spack/var/spack/environments/gysela-deisa-irene-skl-draft/.spack-env/view/lib/python3.9/site-packages/tornado/ioloop.py", line 905, in _run
0:     return self.callback()
