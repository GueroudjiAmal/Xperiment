...
+ wait 40975
+ ccc_mprun -N 8 -n 16 -r 2 dask-worker --local-directory /tmp --scheduler-file=scheduler.json
++ which python3
...
+ wait
slurmstepd-irene1025: error: *** JOB 7587424 ON irene1025 CANCELLED AT 2022-12-13T11:32:37 ***
