...
+ wait 82537
+ ccc_mprun -N 32 -n 64 -r 2 dask-worker --local-directory /tmp --scheduler-file=scheduler.json
++ which python3
+ ccc_mprun -N 1 -n 1 -c 24 -r 1 -l /ccc/work/cont003/gen2224/gen2224/spack/var/spack/environments/gysela-deisa-irene-skl-draft/.spack-env/view/bin/python3 derivative_post.py
+ wait
slurmstepd-irene1393: error: *** JOB 7587569 ON irene1393 CANCELLED AT 2022-12-13T11:29:28 ***
